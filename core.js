(function(){
  ...
  const App = {
    ...
    theme: (function(){
      ...
      return {
        brandName: t.brandName || 'Sofia',
        brandShort: t.brandShort || 'Sofia',
        logoText: t.brandName || 'Sofia',
        primary: colors.brand || '#204080',
        primaryLight: colors.brandLight || colors.brand || '#3b5ba7',
        accent: colors.accent || '#4666b0',
        text: colors.text || '#0f172a',
        muted: colors.muted || '#64748b',
        success: colors.success || '#10b981',
        warning: colors.warning || '#f59e0b',
        info: colors.info || '#0b1739',
        border: colors.border || '#e2e8f0',
        bannerText: t.bannerText || 'Sistema Agéntico',
        logoUrl: t.logoUrl || 'assets/logo.svg',
        bannerUrl: t.bannerUrl || 'assets/banner.svg',
        footer: t.footer || { text: '© 2025 Fibex Telecom', links: [] }
      };
    })(),
    tokens: {
