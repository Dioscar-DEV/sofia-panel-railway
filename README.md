# Sofia - Sistema Agéntico

## 🎯 Descripción

Sofia es un sistema agéntico propiedad de Fibex Telecom, construido con un sistema modular ultra-flexible usando HTML, CSS y JavaScript puro, diseñado para ser completamente configurable desde Supabase. El sistema permite cambiar colores, logos, textos y toda la configuración visual directamente desde la base de datos, sin necesidad de modificar código.
...
Sofia está diseñada para ser simple, flexible y poderosa. ¡Esperamos que te sea útil para tus proyectos!

---

**Desarrollado con ❤️ para Fibex Telecom**
